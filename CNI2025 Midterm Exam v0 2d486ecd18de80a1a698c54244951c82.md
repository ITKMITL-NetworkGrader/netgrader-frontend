# CNI2025 Midterm Exam v0

ชื่อ-นามสกุล ………………………………………………………………………………………..

เลขประจำตัวนักศึกษา ……………………………………………………………………………

![Screenshot 2568-12-25 at 21.42.24.png](Screenshot_2568-12-25_at_21.42.24.png)
...
2. สอบเวลา 09:30-12:30 น. เข้าห้องสอบได้ตั้งแต่เวลา 09:15 น.
...
1. เมื่อหมดเวลาสอบให้รอจนตรวจข้อสอบเสร็จและทราบคะแนนก่อน จึงออกจากห้องสอบ
2. ทำการสร้าง Lab ใหม่ และ Add nodes และ Add Links ดังรูป Topology ด้านบน 
3. เกณฑ์การให้คะแนน
...
1. กำหนดให้  IPv4 เป็นค่า **`[172.X.Y.128/23]`**  และกำหนดให้ ****VLAN A กับ B โดย X, Y, Z, A, B, C จะเป็นเลขที่ถูกสุ่มขึ้นมาของแต่ละคน ตามค่าในตารางด้านบน
    - Subnet 1: Subnet VLAN ที่มี PC1, PC3 (VLAN **`A`**) มี IP ที่สามารถใช้งานได้อย่างน้อย `100` IP และต้องใกล้เคียงมากที่สุด
    - Subnet 2: Subnet VLAN ที่มี PC2 และ S2 (VLAN **`B`**) มี IP ที่สามารถใช้งานได้อย่างน้อย `20` IP และต้องใกล้เคียงมากที่สุด
    - Subnet 3: Subnet VLAN ที่มี PC4 และ S1 (VLAN **`C`**) มี IP ที่สามารถใช้งานได้อย่างน้อย `5` IP และต้องใกล้เคียงมากที่สุด
    
    ให้แบ่ง Subnet VLAN `A`  ก่อน Subnet VLAN `B` และก่อน Subnet VLAN `C`  ดังนั้นค่า Subnet Number ของ VLAN `A` จะต้องน้อยกว่า Subnet Number ของ VLAN `B`
...
# Part 3: 5 คะแนน (30 นาที)

## Basic Connectivity

1. [0.25 คะแนน] PC-1 สามารถ Ping IPv4 S0 ได้
2. [0.25 คะแนน] PC-1 สามารถ Ping IPv4 PC-2 ได้
3. [0.25 คะแนน] PC-1 สามารถ Ping IPv4 Router0 (E0/0) ได้
4. [0.25 คะแนน] PC-2 สามารถ Ping IPv4 S0 ได้
5. [0.25 คะแนน] PC-2 สามารถ Ping IPv6 PC1 ได้
6. [0.25 คะแนน] PC-2 สามารถ Ping IPv6 S0 ได้
7. [0.25 คะแนน] PC-1 สามารถ Ping IPv6 PC-2 ได้
8. [0.25 คะแนน] PC-2 สามารถ Ping IPv6 Router0 (E0/0) ได้
9. [0.25 คะแนน] PC-1 สามารถ Ping IPv4 WebServer (IP `172.17.1.100/24`) ที่อยู่ใน Instructor Pod ได้
10. [0.25 คะแนน] PC-2 สามารถ Ping IPv4 WebServer (IP `172.17.1.100/24`) ที่อยู่ใน Instructor Pod ได้
11. [0.25 คะแนน] PC-1 สามารถ Ping IPv4 1.1.1.1 ได้ 
12. [0.25 คะแนน] PC-2 สามารถ Ping IPv4 1.1.1.1 ได้
13. [0.25 คะแนน]
14. [0.25 คะแนน]
15. [0.25 คะแนน]
16. [0.25 คะแนน]
